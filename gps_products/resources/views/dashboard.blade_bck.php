...
@section('scripts')
    ...
    <script>
        ...
        //             address1:"<img src='{{ $product->image_url }}' class='img_maps'>",
        //             address2: "<p><span class='pro_price'>{{ $product->min_bid }}</span> <a href='{{ route('subscriptions') }}'>Starting Bid</a></p>",
        //             postalCode: "<p class='auc_online'> Status: {{ $product->status }} </p><p class='text-center'><a href='{{ route('products', ['id' => $product->id ]) }}' class='btn btn-info'>Details</a></p>",
        //          },
        //       @endforeach
        ...
        function displayMarkers(setMap) {
            ...
            if (markersData != "[]") {
                for (var i = 0; i < markersData.length; i++) {
                    ...
                    createMarker(latlng, name, address1, address2, postalCode, url);
            ...
            var marker = new google.maps.Marker({
                ...
                position: latlng,
                title: "Me",
                icon: "{{asset('asset/images/me.png')}}"
            });
        ...
        function createMarker(latlng, name, address1, address2, postalCode, url) {
            ...
            /*if(url == "active"){
                marker.setIcon('{{asset('asset/images/active.png')}}');
            }*/
