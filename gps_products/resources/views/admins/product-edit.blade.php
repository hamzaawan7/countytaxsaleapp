            ...
            <div class="col-sm-12">
                <div class="panel-box">
                    <div class="col-sm-8 col-sm-offset-2">
                        ...
                        <h4>Edit Property</h4>
                        <form class="form-horizontals" method="POST" action="{{ route('admin-update-products') }}"
                              enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="row">
                                <div class="col-sm-12">
                                    <img src="{{ $product->image_url }}" alt="{{ $product->address }}"
                                         class="profile-user-img img-responsive img-circle">

                                    <div class="form-group{{ $errors->has('location') ? ' has-error' : '' }}">
                                        <label for="title" class="control-label"> Address</label>
                                        <input id="searchInput" class="input-controls" type="text"
                                               placeholder="Enter a location" value="{{ $product->address }}">
                                        <div class="map" id="map" style="width: 100%; height: 300px;"></div>
                                        <div class="form_area">
                                            <input type="hidden" name="location" id="location"
                                                   value="{{ $product->address }}">
                                            <input type="hidden" name="lat" id="lat" value="{{ $product->lat }}">
                                            <input type="hidden" name="lng" id="lng" value="{{ $product->lng }}">
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group{{ $errors->has('photo') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" name="photo" id="photo" placeholder="Write Image URL"
                                                       class="form-control" value="{{ $product->image_url }}">
                                                @if ($errors->has('photo'))
                                                    <span class="help-block">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group{{ $errors->has('land_sf') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" name="land_sf" id="land_sf" value="{{ $product->land_sf }}" placeholder="LandSF" class="form-control"  value="{{ old('land_sf') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group{{ $errors->has('exemption_type') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" name="exemption_type" id="exemption_type" placeholder="Exemption Type" value="{{ old('exemption_type') }}" class="form-control">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" name="amount" id="amount" placeholder="Write Account"
                                                       class="form-control" value="{{ $product->account }}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="hcad" id="hcad" placeholder="Write Total Sale"
                                                       class="form-control" value="{{ $product->hcad }}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group{{ $errors->has('cause') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" name="cause" id="cause" placeholder="Write Cause"
                                                       class="form-control" value="{{ $product->cause }}">
                                                @if ($errors->has('cause'))
                                                    <span class="help-block">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group{{ $errors->has('start_tax') ? ' has-error' : '' }}">
                                                ...
                                                <select name="start_tax" id="start_tax" class="form-control">
                                                    ...
                                                    @if( substr($product->tax_years,0,4) != '')
                                                        <option value="{{  substr($product->tax_years,0,4) }}"
                                                                selected="selected">{{  substr($product->tax_years,0,4) }}</option>
                                                    @endif
                                                </select>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group {{ $errors->has('end_tax') ? ' has-error' : '' }}">
                                                ...
                                                <select name="end_tax" id="end_tax" class="form-control">
                                                    ...
                                                    <option value="2019">2019</option>
                                                    <option value="2020">2020</option>
                                                    @if( substr($product->tax_years,5,10) != '')
                                                        <option value="{{  substr($product->tax_years,5,10) }}"
                                                                selected="selected">{{  substr($product->tax_years,5,10) }}</option>
                                                    @endif
                                                </select>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                                                ...
                                                <select name="type" id="type" class="form-control">
                                                    <option value="SALE"
                                                            @if($product->type == 'SALE') selected="selected" @endif>
                                                        SALE
                                                    </option>
                                                    <option value="RESALE"
                                                            @if($product->type == 'RESALE') selected="selected" @endif>
                                                        RESALE
                                                    </option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group {{ $errors->has('status') ? ' has-error' : '' }}">
                                                ...
                                                <select name="status" id="status" class="form-control">
                                                    <option value="active"
                                                            @if($product->status == 'active') selected="selected" @endif>
                                                        Active
                                                    </option>
                                                    <option value="cancelled"
                                                            @if($product->status == 'cancelled') selected="selected" @endif>
                                                        Cancelled
                                                    </option>
