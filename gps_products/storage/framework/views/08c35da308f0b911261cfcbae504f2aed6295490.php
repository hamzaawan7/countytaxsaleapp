       ...
       <?php echo $__env->make('layouts.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        <div id="page-content-wrapper">
            ...
            <div class="col-xs-12">
                <div class="row">
                    <div class="account_stat  wow fadeInUp">
                        ...
                        <div class="col-xs-6"><h4 class="pull-right"><?php if(isset(Auth::user()->premium_user->status)): ?> <?php echo e(ucfirst(Auth::user()->premium_user->status)); ?> <?php endif; ?></h4></div>
                    </div>
                </div>
            ...
            <div class="col-xs-11 col-sm-12 col-md-11">
              <h4 style="text-align: center;">YOUR CREDIT CARD WILL NOT BE CHARGED UNTIL FREE TRIAL PERIOD ENDS</h4>
            </div>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-xs-12" style="text-align: center;">
                  <form action="<?php echo e(route('new-card')); ?>"" method="post">
          ...
          data-locale="auto">
              ...
              <ul>   
               <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="col-xs-11 col-sm-4 col-md-3 visa stored-card cr-cd<?php echo e($list->id); ?>" data-vendor="visa" style="margin-left: 5px;">
                <div class="vendor"><?php echo e($list->card_type); ?></div>
                <div class=""></div>
                <div class="card-number"> <span>✖✖✖✖</span> <span>✖✖✖✖</span> <span>✖✖✖✖</span> <span><?php echo e(substr($list->card_number, -4)); ?></span></div>
                <div class="card-name"><?php echo e($list->cardholder_name); ?></div>
                <button style="margin-top: 170px;margin-bottom: 10px; " data-id="<?php echo e($list->id); ?>" class="r<?php echo e($list->id); ?> btn btn-danger btn-remove pull-right">Remove</button>
                </li>
              ...
              <div class="row">
                <div class="account_prem  wow fadeInUp">
                  <div class="premium_box">
                    <img src="<?php echo e(asset('asset/images/premium.png')); ?>"  alt="">
                    <h2>Premium</h2>
          <p>Referal Id : 25488</p>
          <p>Balance : $4.00</p>
                    <a href="<?php echo e(route('premium-payment-form')); ?>" class="btn btn-default price_btns">$4.99/mo</a>
                  </div>
                  <div class="clearfix"></div>
                </div>
