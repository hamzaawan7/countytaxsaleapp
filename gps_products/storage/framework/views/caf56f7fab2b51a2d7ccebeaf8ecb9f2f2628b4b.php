...
<head>
    ...
    <!-- DATATABLES-->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/dataTables.colVis.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/dataTables.bootstrap.css')); ?>">
...
<div id="wrapper">
    ...
    <div class="topbar">
        <div class="topbar-left">
            ...
            <!-- <a href="" class="logo text-center"><img src="<?php echo e(asset('assets/images/logo.png')); ?>" alt=""></a> -->
            ...
            <li class="dropdown profile-link hidden-xs">
                <div class="clearfix">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <span><?php echo e(Auth::user()->name); ?> <br><em><?php echo e(ucfirst(Auth::user()->type)); ?></em></span>
                    </a>
                </div>
        ...
        <ul class="metismenu clearfix" id="menu">
            ...
            <li>
                <a href="<?php echo e(route('admin-products')); ?>">
                    <i class="fa fa-cogs" aria-hidden="true"></i> <span>Properties</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('import-export')); ?>">
                    <i class="fa fa-file-excel-o"></i> <span>Property Upload</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-contact-messages')); ?>">
                    <i class="fa fa-envelope" aria-hidden="true"></i> <span>Contact Messages</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-legals')); ?>">
                    <i class="fa fa-balance-scale" aria-hidden="true"></i> <span>Legals</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-trial-days')); ?>">
                    <i class="fa fa-sun-o" aria-hidden="true"></i> <span>Trial Days</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-trial-amount')); ?>">
                    <i class="fa fa-dollar" aria-hidden="true"></i> <span>Trial Amount</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-auction-date')); ?>">
                    <i class="fa fa-volume-up" aria-hidden="true"></i> <span>Auction Date</span>
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('admin-homepage-questions')); ?>">
                    <i class="fa fa-question" aria-hidden="true"></i> <span>HomePage Questions</span>
                </a>
            </li>
            <li class="active">
                <a href="#">
...
<script src="<?php echo e(asset('assets/js/jquery.flot.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery.flot.time.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery.flot.tooltip.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery.flot.resize.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery.flot.pie.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery.flot.selection.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery.flot.stack.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/jquery.flot.crosshair.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/raphael-2.1.0.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('assets/js/dataTables.colVis.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/dataTables.bootstrap.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/demo-datatable.js')); ?>"></script>
